...
HD_PWD='H:/ZynqUltralScaleXCZU15EG/FMC121_AD/FMC121_AD.runs/GLB_dcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GLB_dcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GLB_dcm.tcl
