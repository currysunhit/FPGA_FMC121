...
HD_PWD='H:/ZynqUltralScaleXCZU15EG/FMC121_AD/FMC121_AD.runs/sysclk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sysclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sysclk.tcl
