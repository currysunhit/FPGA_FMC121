...
#
# Generated by export_simulation on Fri Mar 10 10:41:15 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './sysclk.sh' script.
...
./sysclk.sh -noclean_files

For more information on the script, please type './sysclk.sh -help'.
