...
--               H:/ZynqUltralScaleXCZU15EG/FMC121_AD/FMC121_AD.srcs/sources_1/ip/GLB_dcm/GLB_dcm_sim_netlist.vhdl
-- Design      : GLB_dcm
...
entity GLB_dcm_GLB_dcm_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of GLB_dcm_GLB_dcm_clk_wiz : entity is "GLB_dcm_clk_wiz";
end GLB_dcm_GLB_dcm_clk_wiz;

architecture STRUCTURE of GLB_dcm_GLB_dcm_clk_wiz is
  signal clk_in1_GLB_dcm : STD_LOGIC;
  signal clk_out1_GLB_dcm : STD_LOGIC;
...
entity GLB_dcm is
  ...
  attribute NotValidForBitStream of GLB_dcm : entity is true;
end GLB_dcm;

architecture STRUCTURE of GLB_dcm is
begin
inst: entity work.GLB_dcm_GLB_dcm_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
